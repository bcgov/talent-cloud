...
export const SCHEDULER_AVAILABLE_TEXT_CLASS = `text-nowrap font-bold text-calGreenTwo text-xs`;
...
export const SCHEDULER_DEPLOYED_TEXT_CLASS = `text-nowrap font-bold text-calBlueTwo text-xs`;
...
export const SCHEDULER_UNAVAILABLE_TEXT_CLASS = `text-nowrap font-bold text-calRedTwo text-xs`;
export const SCHEDULER_NOT_INDICATED_CLASS = 'h-20 border-l border-cyan-950 bg-white hover:bg-gray-200 cursor-pointer';
export const SCHEDULER_NO_DATE_CLASS = 'h-20 border-l border-cyan-950 bg-disabledGray';