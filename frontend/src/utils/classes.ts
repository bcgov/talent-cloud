...
export const SCHEDULER_AVAILABLE_TEXT_CLASS = `text-nowrap font-bold text-forest-900 text-xs pointer-events-none`;
...
export const SCHEDULER_DEPLOYED_TEXT_CLASS = `text-nowrap font-bold text-calBlueTwo text-xs pointer-events-none`;
...
export const SCHEDULER_AVAILABLE_MEMBER_CLASS =
  'h-20 border-l border-cyan-950 bg-white hover:bg-dark-300 cursor-pointer';
export const SCHEDULER_NO_DATE_CLASS = 'h-20 border-l border-cyan-950 bg-gray-400';
