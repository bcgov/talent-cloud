...
const BcwsProfileDetails = ({
  ...
  const generalInformation = [
    {
      title: 'Date Applied',
      content: personnel?.dateApplied ? datePST(personnel.dateApplied as Date) : '-',
    },
    {
  ...
  const organizational = [
    ...
    { title: 'Liason Phone Number', content: formatPhone(personnel.liaisonPhoneNumber) ?? 'Not Listed' },
...
export default BcwsProfileDetails;
