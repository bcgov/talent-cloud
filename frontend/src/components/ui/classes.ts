export const button = {
  secondaryButton:
'bg-transparent border border-2 rounded-sm  px-6 h-[34px] border-primaryBlue text-center block font-semibold text-xs text-decoration-none whitespace-nowrap hover:underline disabled:opacity-30',
