export const classes = {
  menu: {
    container:
      'bg-white rounded-sm  shadow-md w-full font-normal h-16 text-sm px-4 text-dark focus:outline-none flex flex-row items-center justify-between aria-disabled="true" aria-haspopup="false" aria-expanded="false" aria-controls=""',
