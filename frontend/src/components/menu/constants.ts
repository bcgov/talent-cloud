export const classes = {
  menu: 'bg-white flex flex-row justify-between rounded-sm px-2 shadow-sm w-full h-12',
  menuButton: 'bg-white flex flex-row w-full justify-between items-center no-wrap',
  ...
  chips: 'flex flex-row items-center justify-start my-2 space-x-4',
};
