...
import { EmcrExperienceEntity, EmcrFunctionEntity, EmcrTrainingEntity, LocationEntity } from '../database/entities/emcr';
...
import { Experience, FirstAid } from './enums';
import { createEMCRhandler } from './emcr-seed';
import { createBCWShandler } from './bcws-seed';
...
export const handler = (
  ...
  const {emcrData} = createEMCRhandler(functions, trainings, status, dateApplied);
