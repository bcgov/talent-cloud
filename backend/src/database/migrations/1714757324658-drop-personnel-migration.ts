...
export class Migration1714757324658 implements MigrationInterface {
  name = 'DropPersonnelMigration1714757324658';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP TABLE IF EXISTS function, personnel_function_experience, personnel_training, training`,
    );
  }
