...
export class Migration1732664280559 implements MigrationInterface {
    name = 'Migration1732664280559'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "emcr_personnel" ALTER COLUMN "travel_preference" SET DEFAULT 'WILLING_TO_TRAVEL_HOME_LOCATION'`);
        ...
        await queryRunner.query(`ALTER TABLE "recommitment_cycle" ADD CONSTRAINT "UQ_9bdc497efce5720701ba9245275" UNIQUE ("year")`);
        await queryRunner.query(`ALTER TYPE "public"."ministry" RENAME TO "ministry_old"`);
        await queryRunner.query(`CREATE TYPE "public"."ministry" AS ENUM('AF', 'AG', 'MCF', 'CITZ', 'ECC', 'EMCR', 'EMLI', 'ENV', 'FIN', 'FOR', 'GCPE', 'HLTH', 'HOUS', 'IRR', 'JEDI', 'LBR', 'MMHA', 'MUNI', 'PREM', 'PSA', 'PSFS', 'PSSG', 'SDPR', 'TACS', 'MOTI', 'WLRS')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "personnel_certifications" DROP CONSTRAINT "FK_62cef66e020ea3a1d90fd0c4087"`);
        await queryRunner.query(`ALTER TABLE "personnel_tools" DROP CONSTRAINT "FK_65844d0c28077778e4b1d6c4f53"`);
        await queryRunner.query(`ALTER TABLE "bcws_personnel" ALTER COLUMN "travel_preference" SET DEFAULT 'WILLING_TO_TRAVEL_UNKNOWN'`);
        await queryRunner.query(`CREATE TYPE "public"."ministry_old" AS ENUM('AF', 'AG', 'CITZ', 'ECC', 'EMCR', 'EMLI', 'ENV', 'FIN', 'FOR', 'GCPE', 'HLTH', 'HOUS', 'IRR', 'JEDI', 'LBR', 'MCF', 'MHA', 'MMHA', 'MOTI', 'MUNI', 'PREM', 'PSA', 'PSFS', 'PSSG', 'SDPR', 'TACS', 'WLRS')`);
        ...
        await queryRunner.query(`ALTER TABLE "recommitment_cycle" DROP CONSTRAINT "UQ_9bdc497efce5720701ba9245275"`);
        await queryRunner.query(`ALTER TABLE "recommitment" ADD CONSTRAINT "FK_1ff108632f076e6d4cdc2e338b8" FOREIGN KEY ("year") REFERENCES "recommitment_cycle"("year") ON DELETE NO ACTION ON UPDATE NO ACTION`);
