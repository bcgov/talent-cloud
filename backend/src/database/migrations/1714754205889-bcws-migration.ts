...
export class Migration1714754205889 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "bcws_certification" ("id" SERIAL NOT NULL, "name" character varying(50) NOT NULL, CONSTRAINT "UQ_b7f42da6dc2c22f47c36b6b7e0f" UNIQUE ("name"), CONSTRAINT "PK_9b19c6f72ba39e8ef498bad37e6" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bcws_role" ("id" SERIAL NOT NULL, "name" "public"."bcws-role" NOT NULL, "section" "public"."bcws-role-section" NOT NULL, CONSTRAINT "PK_8085c37cddd6bc7755e8d807c87" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "bcws_tools" ("id" SERIAL NOT NULL, "name" "public"."bcws-tools" NOT NULL, CONSTRAINT "PK_2aa1d18f606874e74e47f5a23cc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
